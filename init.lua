...
vim.keymap.set('v', '<A-j>', ':m >+1<CR>gv=gv', { noremap = true, silent = true }) -- Move current line up
vim.keymap.set('v', '<A-k>', ':m >-2<CR>gv=gv', { noremap = true, silent = true }) -- Move current line up
